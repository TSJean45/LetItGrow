...
const Footer = () => {
  ...
  return (
    <footer className="text-gray-500 bg-white px-4 pt-20 my-10 max-w-screen-xl mx-auto md:px-8">
      <hr></hr>
      <div className="max-w-lg sm:mx-auto py-5 sm:text-center">
      ...
      <div className="mt-8 items-center justify-between sm:flex">
        <div className="mt-4 sm:mt-0">
          &copy; 2024 LetItGrow All rights reserved.
        </div>
